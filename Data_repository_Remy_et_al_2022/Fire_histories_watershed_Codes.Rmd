...
colnames(Ros_T)<-c("Age","MeanArea")

AreaRosalia_plot<-
ggplot(Ros_T,aes(x=Age,y=MeanArea))+
   theme_classic()+ 
   scale_x_reverse(breaks =seq(0,100000,1000),limits=c(9052.5,32.5))+
   scale_y_log10("y",limits = c(0.01,1e0))+           
   geom_point(aes(x=Age,y=MeanArea),colour="grey40",size=0.8)+
   geom_smooth(span=0.1,color="red4",size=1)+
   geom_hline(yintercept=mean(Ros_T$MeanArea,na.rm=T),linetype="dashed")+ 
   labs(x="Age(yrs cal. BP)",y="Charcoal area (log10 mm2)",title="Charcoal Area - Rosalia")+
   theme(text=element_text(family="Times",size=12)) 
AreaRosalia_plot
```   
...
ggplot(data=Ros_T,aes(x=Age,y=LW))+
   ...
   labs(x="Age(yrs cal. BP)",y="Charcoal aspect (log10 L/W ratio)",title="Charcoal aspect - Rosalia") +
   theme(text=element_text(family="Times",size=12)) 
LWRosalia_plot
```  
...
colnames(Pik_T)<-c("Age","MeanArea")

AreaPikku_plot<-
ggplot(Pik_T,aes(x=Age,y=MeanArea))+
   theme_classic()+ 
   scale_x_reverse(breaks =seq(0,100000,1000),limits=c(9046,-34))+
   scale_y_log10("y",limits = c(0.01,1e0))+           
   geom_point(aes(x=Age,y=MeanArea),colour="grey40",size=0.8)+
   geom_smooth(span=0.1,color="red4",size=1)+
   geom_hline(yintercept=mean(Pik_T$MeanArea,na.rm=T),linetype="dashed")+ 
   labs(x="Age(yrs cal. BP)",y="Charcoal area (log10 mm2)",title="Charcoal Area - Pikku")+
   theme(text=element_text(family="Times",size=12)) 
AreaPikku_plot
```   
...
ggplot(data=Pik_T,aes(x=Age,y=LW))+
   ...
   geom_hline(yintercept=c(2.5))+
   geom_hline(yintercept=c(3.5))+
   labs(x="Age(yrs cal. BP)",y="Charcoal aspect (log10 L/W ratio)",title="Charcoal aspect - Pikku") +
   theme(text=element_text(family="Times",size=12)) 
LWPikku_plot
``` 
